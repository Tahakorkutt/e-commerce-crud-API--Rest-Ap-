...
Rating'i sayıya dönüştürdüm (Number(rating)).
Product'ı bulmadan önce kontrol ekledim ve uygun bir hata mesajı döndürdüm.
product.reviews'e review ekledikten sonra product.save() ile kaydettik.
Hataların uygun şekilde yönetilmesi için try-catch bloğu kullanıldı.
Bu şekilde, bir ürünün incelemelerine review ekleyebilirsiniz. Kodunuzu bu şekilde dü
